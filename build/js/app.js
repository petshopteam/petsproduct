	...
	$.fn.flexMenu = function (options) {
		var checkFlexObject,
			s = $.extend({
				...
				'linkTextAll' : 'МЕРОПРИЯТИЯ', // [string] If we hit the cutoff, what text should we display on the "view more" link?
				'linkTitleAll' : 'МЕРОПРИЯТИЯ', // [string] If we hit the cutoff, what should the title of the "view more" button be?
        ...
        for (i = numItems; i > 1; i--) {
				...
				if (allInPopup) {
					...
					$this.append('<li class="flexMenu-viewMore catalog-menu-list__item"><a href="#" title="' + s.linkTitle + '">' + s.linkText + '</a></li>');
				}
